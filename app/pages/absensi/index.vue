...
<template>
  <PTKLayout>
    ...
    >
      ...
      <div class="flex-1 min-w-0">
        <p class="text-sm font-bold text-gray-900 dark:text-gray-100">Hasil Rating & Ulasan Kelas</p>
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Lihat evaluasi, bintang, dan masukan dari murid untuk setiap sesi kelas</p>
      </div>
      <svg class="w-4 h-4 text-gray-300 dark:text-slate-500 flex-shrink-0 transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
      </svg>
